    ...
    <footer>
        ...
        <div class="row">
          ...
          <div class="column">
            ...
            <p>Discover Paper Mart, your one-stop e-commerce for all paper needs. Enjoy fast shipping and exceptional service today!</p>
          ...
          <div class="column">
            ...
            <ul>
              ...
              <li><a href="orderdisp.php"><i class="fa fa-angle-right"></i>YOUR CART</a></li>

              <li><a href="order.php"><i class="fa fa-angle-right"></i>YOUR ORDER</a></li>
          ...
          <div class="column">
            ...
            <ul>
              ...
              <li><a href="complain.php"><i class="fa fa-angle-right"></i>COMPLAIN</a></li>
