        ...
        <div class="row">
          ...
          <div class="column">
            ...
            <ul>
              ...
              <li><a href="dryfruit.php"><i class="fa fa-angle-right"></i>ADD PRODUCT</a></li>
        
              <li><a href="product.php"><i class="fa fa-angle-right"></i>VIEW PRODUCT</a></li>

              <li><a href="orderdisp.php"><i class="fa fa-angle-right"></i>VIEW ORDER</a></li>
          ...
          <div class="column">
            ...
            <ul>
              ...
              <li><a href="reguser.php"><i class="fa fa-angle-right"></i>USER</a></li>

              <li><a href="feedbckdisp.php"><i class="fa fa-angle-right"></i>FEEDBACK VIEW</a></li>
        
              <li><a href="complaindisp.php"><i class="fa fa-angle-right"></i>COMPLAIN VIEW</a></li>

              <li><a href="logout.php"><i class="fa fa-angle-right"></i>SIGN-OUT📴</a></li>
